...
//    }
//
//    Client generateClient(String str, short num) {
//        String firstname = "Anton"+str;
//        String middlename = "Ivanovich"+str;
//        String lastname = "Pavlov"+str;
...
//        invoice.setDateAndTime(new Timestamp(System.nanoTime()));
...
//        session.save(pack2);
//        checkSessionClose(session);
//        Session session1 = checkSessionOpen();
//        session1.save(clientsPackages1);
////        session1.save(clientsPackages2);
//        session1.save(courier);
//        session1.save(invoice);
//        checkSessionClose(session1);
//
//    }
//}
